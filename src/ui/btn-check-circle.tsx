...
function BtnCheckCircle(props: Props) {
    return (
        <button
...
BtnCheckCircle.defaultProps = {
    class: undefined,
    onclick: (): void => { console.warn('realise action: onclick for BtnCheckCircle')}
  }

export default BtnCheckCircle;
